...
<div class="container b-container-index">
	...
	<!-- START BLOCK UTILITY -->
	<section class="b-utility">
		<section class="container">
			<div class="row b-utility_bg">
				<div class="col-md-3 col-xs-6">
					<i class="icon bc-anchor"></i>
					<h3 class="l-title_h3">Awesome Themes</h3>
					<span>55</span>
				</div>

				<div class="col-md-3 col-xs-6">
					<i class="icon bc-tools-2"></i>
					<h3 class="l-title_h3">Useful Extensions</h3>
					<span>17</span>
				</div>

				<div class="col-md-3 col-xs-6">
					<i class="icon bc-profile-male"></i>
					<h3 class="l-title_h3">Team Members</h3>
					<span>22</span>
				</div>

				<div class="col-md-3 col-xs-6">
					<i class="icon bc-heart"></i>
					<h3 class="l-title_h3">Loyal Clients</h3>
					<span>58711</span>
				</div>
			</div>
		</section>
	...
	<section class="b-reviews">
		<section class="container">
			<div class="b-bg-reviews row">
				<header class="l-center">
					<h2 class="l-title">Clients gratitude</h2>
					<h3 class="l-subtitle">Proin iaculis purus consequat sem cure digni</h3>
				</header>
					...
					<article class="l-center">
						...
						<div class="b-reviews-info">
							<figure>
								...
								<figcaption>
									<p>Shamim Chowdhury</p>
									<span>CEO, ThemeXpert</span>
								</figcaption>
							</figure>
						</div>
					</article>
		...
		<section class="container">
			<div class="row b-clients_bg">
				<div class="j-comps">
					...
					<div>
						<a href="#">
							<img src="/images/clients/img2.jpg" alt="">
						</a>
					</div>
					<div>
						<a href="#">
							<img src="/images/clients/img3.jpg" alt="">
						</a>
					</div>
					<div>
						<a href="#">
							<img src="/images/clients/img4.jpg" alt="">
						</a>
					</div>
					<div>
						<a href="#">
							<img src="/images/clients/img5.jpg" alt="">
						</a>
					</div>
					<div>
						<a href="#">
	...
	<section class="b-team">
		<section class="container">
			<div class="row b-team_bg">
				<header class="l-center">
					<h2 class="l-title">Meet the team</h2>
					<h3 class="l-subtitle">Proin iaculis purus consequat sem cure digni ssim posuere odio</h3>
				</header>
				...
				<div>
					<div class="col-md-4 col-xs-6">
						<div class="col-md-6 col-xs-6 arrow-right j-team-height">
							<img src="/images/team/img1.jpg" alt="">
						</div>
						<div class="col-md-6 col-xs-6 j-team-height b-desc_team">
							<div>
							   	<p><span class="b-team_role">CEO</span></p>
              					<p><span class="b-team_name">Parvez Akhter</span></p>
              
				              	<ul class="b-social_icons clearfix">
				               		<li>
					               	...
					               	<li>
					                	<a href="#" target="_blank">
					                 	<i class="bc-googleplus"></i>
					                	</a>
					               	</li>

					               	<li>
					                	<a href="#" target="_blank">
					                 		<i class="bc-linkedin"></i>
					                	</a>
					               	</li>
				              	</ul>
			              	</div>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="col-md-6 col-xs-6 b-desc_team j-team-height">
							<div>
							   	<p><span class="b-team_role">CEO</span></p>
              					<p><span class="b-team_name">Parvez Akhter</span></p>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="col-md-6 col-xs-6 arrow-left j-team-height">
